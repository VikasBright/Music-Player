...
import com.example.mymusicplayer.appwidgets.*
import com.example.mymusicplayer.auto.AutoMediaIDHelper
import com.example.mymusicplayer.auto.AutoMusicProvider
import com.example.mymusicplayer.extensions.showToast
import com.example.mymusicplayer.extensions.toMediaSessionQueue
import com.example.mymusicplayer.extensions.uri
import com.example.mymusicplayer.glide.BlurTransformation
import com.example.mymusicplayer.glide.RetroGlideExtension.getSongModel
import com.example.mymusicplayer.glide.RetroGlideExtension.songCoverOptions
import com.example.mymusicplayer.helper.ShuffleHelper.makeShuffleList
import com.example.mymusicplayer.model.Song
import com.example.mymusicplayer.model.Song.Companion.emptySong
import com.example.mymusicplayer.model.smartplaylist.AbsSmartPlaylist
import com.example.mymusicplayer.providers.HistoryStore
import com.example.mymusicplayer.providers.MusicPlaybackQueueStore
import com.example.mymusicplayer.providers.SongPlayCountStore
import com.example.mymusicplayer.service.notification.PlayingNotification
import com.example.mymusicplayer.service.notification.PlayingNotificationClassic
import com.example.mymusicplayer.service.notification.PlayingNotificationImpl24
import com.example.mymusicplayer.service.playback.Playback
import com.example.mymusicplayer.service.playback.Playback.PlaybackCallbacks
import com.example.mymusicplayer.util.MusicUtil
import com.example.mymusicplayer.util.MusicUtil.toggleFavorite
import com.example.mymusicplayer.util.PackageValidator
import com.example.mymusicplayer.util.PreferenceUtil.crossFadeDuration
import com.example.mymusicplayer.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.example.mymusicplayer.util.PreferenceUtil.isBluetoothSpeaker
import com.example.mymusicplayer.util.PreferenceUtil.isBlurredAlbumArt
import com.example.mymusicplayer.util.PreferenceUtil.isClassicNotification
import com.example.mymusicplayer.util.PreferenceUtil.isHeadsetPlugged
import com.example.mymusicplayer.util.PreferenceUtil.isLockScreen
import com.example.mymusicplayer.util.PreferenceUtil.isPauseOnZeroVolume
import com.example.mymusicplayer.util.PreferenceUtil.playbackPitch
import com.example.mymusicplayer.util.PreferenceUtil.playbackSpeed
import com.example.mymusicplayer.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.example.mymusicplayer.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.example.mymusicplayer.volume.AudioVolumeObserver
import com.example.mymusicplayer.volume.OnAudioVolumeChangedListener
...
//    }
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.example.mymusicplayer"
