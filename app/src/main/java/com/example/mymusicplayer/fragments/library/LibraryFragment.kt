...
package com.example.mymusicplayer.fragments.library
...
import com.example.mymusicplayer.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Music<span  style='color:$hexColor';>Player</span>".parseAsHtml()
